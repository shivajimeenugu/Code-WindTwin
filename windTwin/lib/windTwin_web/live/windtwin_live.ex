defmodule WindTwinWeb.WindTwinLive do
  ...
  def render(assigns) do
    ~H"""
    <div style="display:none" class=" p-5 h-2/6 grid gap-y-10 gap-x-6 md:grid-cols-3 xl:grid-cols-3">

            <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
              <div
                  class="bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-blue-500/40 shadow-lg absolute -mt-4 grid h-16 w-16 place-items-center">
            ...
            <div class="p-4 text-right">
                <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Voltage</p>
                <h4
                    class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                    10V</h4>
            </div>
            ...
            <div class="p-4 text-right">
              <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Body Vibration</p>
              <h4
                  class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                  500</h4>
            </div>
  ...
  def handle_info(%{event: "updatereal", payload: payload}, socket) do
